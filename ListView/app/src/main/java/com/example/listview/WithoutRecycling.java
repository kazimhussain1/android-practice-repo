...
public class WithoutRecycling extends AppCompatActivity {
    ...
    private Place[] myPlacesArray = new Place[]{
    ...
    private PlaceAdapter myPlaceAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_without_recycling);
        ...
        myPlaceAdapter = new PlaceAdapter(getApplicationContext(),R.layout.row, myPlacesArray);

        if (myListView != null) {
            myListView.setAdapter(myPlaceAdapter);
        }
        ...
        myListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(getApplicationContext(),myPlacesArray[position].mPopup,Toast.LENGTH_LONG).show();
